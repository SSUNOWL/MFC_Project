...
IMPLEMENT_DYNAMIC(CAdressDlg, CDialogEx)

CAdressDlg::CAdressDlg(CWnd* pParent /*=nullptr*/)
...
void CAdressDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//  DDX_IPAddress(pDX, IDC_IPADDRESS_IP, m_strAdress);
	DDX_Text(pDX, IDC_EDIT_NAME, m_strName);
	DDX_Control(pDX, IDC_IPADDRESS_IP, m_ipaddress_ip);
}


BEGIN_MESSAGE_MAP(CAdressDlg, CDialogEx)
	ON_BN_CLICKED(IDOK, &CAdressDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CAdressDlg 메시지 처리기

void CAdressDlg::OnBnClickedOk()
{
